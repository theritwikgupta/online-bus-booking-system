	...
	<body class="landing">
		...
		<!-- Header -->
			<header id="header">
				...
				<h1><a href="home.php">Green Bus</a></h1>
				<nav id="nav">
					<ul>
						...
						<li><a href="#contact">Contact</a></li>
	                                        <li><a href="GYMlogin.php">login</a></li> 
					</ul>
				</nav>
			</header>
		...
		<a name="about"></a>
			<section id="one" class="wrapper style1 align-center">
				<div class="container">
					<header>
						<h2>GREEN BUS</h2>
						<p> <b>Green Bus is a online bus reservation system. <br>You can now choose your bus and your seat easily, have the tickets delivered to your mail and online payments. <br>Try Green experience today.</b></p>
			...
			<section id="two" class="wrapper style2 align-center">
				<div class="container">
					...
					-->	</section>
						...
						<p><b> Why Green Bus for Bus Booking? </b>
...
<p><b>Booking Bus Ticket with Green Bus</b> <br>
...
<a name="contact"></a>
		<!-- Footer -->
			...
			<!--				<ul class="icons">
					...
					<ul class="copyright">
						<li>&copy; 2020 green Bus. All rights reserved.</li>
