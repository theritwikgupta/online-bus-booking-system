...
if(isset($_POST['submit']))
{
  ...
  $password=$_POST["password"];
    ...
    $sql="select * from admin where  username='$_POST[mno]'  and  password='$_POST[password]'   ";
...
<header>
 ...
 <nav class=  "navbar navbar-expand-md navbar-dark bg-dark fixed-top">
  ...
  <div class="container">
    ...
    <a  href="index.php" class=navbar-brand text-warningfont weight-bold"> <h3 style= color:#FFFE00 ;> GREEN BUS</h3>
    </a>
...
<center>
  <form  action=" "  method="post" class="login-container">
    <p><input type="text" placeholder="Enter Username" name="mno" required></p>
    <p><input type="password" placeholder="Enter Password" name="password" required></p>

    <p><input type="submit" value="Log in" name="submit" ></p><br><br>
