...
?>
<?php
$query = "select * from busreg order by bid desc limit 1";
...
{
$qq="insert into busreg VALUES('$bid','$bno','$sl','$sw','$sss')";
...
{
echo '<script>alert("Sorry !Your Data Not Inserted, Bus Number Already Exist ")</script>'; 
}
}
}
?>
...
<br><br><br><br>
<div class="login">
  <h2 class="login-header">Bus Registration</h2>
<center>
  <form action=" " method="post" class="login-container">
<p><input type="text" name="mid"  value="<?php echo $empid ?>" style=color:blue; readonly ></p>
    <p><input type="text" placeholder="Enter Bus Number" name="bno" required></p>
 
<p><input type="text" placeholder="Enter Seat Limit" name="sl" required></p>

<p><input type="text" placeholder="Enter Window Seat Limit" name="sw" required></p>
...
$result = mysqli_query($conn,"SELECT * FROM busreg  ");
?>

<center>
<h2>LIST OF REGISTERED BUSES</h2>
<?php
