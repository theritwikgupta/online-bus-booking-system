 ...
 <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarExample01">
             ...
             <a class="btn btn-outline-light ml-5 mr-5" href="busde.php" role="button">Bus Details</a>
		     <a class="btn btn-outline-light  ml-5 mr-5" href="Bushe.php" role="button">Bus schedule</a>
			 <a class="btn btn-outline-light  ml-5 mr-5" href="busdri.php" role="button">Add Driver</a>
			 	 <a class="btn btn-outline-light  ml-5 mr-5" href="###" role="button">View Passengers</a>
				 	 <a class="btn btn-outline-light  ml-5 mr-5" href="##" role="button">Reports</a>
